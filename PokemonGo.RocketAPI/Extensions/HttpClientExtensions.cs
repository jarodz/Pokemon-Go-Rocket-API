...
namespace PokemonGo.RocketAPI.Extensions
{
    public static class HttpClientExtensions
    {
            ...
            where TResponsePayload : IMessage<TResponsePayload>, new()
        {
            ...
            {
                //Debug.WriteLine($"Request of type {typeof(TResponsePayload).Name} returned an invalid or empty payload");
                throw new InvalidResponseException("Empty response received to : " + typeof(TResponsePayload).Name + " request");
            }
